 ...
 */
final class Version20210319103135 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cooking_history (id INT AUTO_INCREMENT NOT NULL, recipe_id INT DEFAULT NULL, datetime DATETIME NOT NULL, INDEX IDX_C4FFEE8359D8A214 (recipe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, coursetype_id INT DEFAULT NULL, source_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, extrainfo VARCHAR(255) NOT NULL, adjustements VARCHAR(255) NOT NULL, INDEX IDX_DA88B1379247AA5D (coursetype_id), INDEX IDX_DA88B137953C1C61 (source_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE source (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, url VARCHAR(1080) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
